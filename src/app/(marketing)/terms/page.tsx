      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-6 text-sm sm:text-base leading-relaxed" style={{ color: "var(--text)" }}>
            ...
            <h2 className="font-bold text-lg sm:text-xl mt-8 mb-3">4. Termination</h2>
            <p>
              We may suspend or terminate your account for violations of these terms.
            </p>
            
            <h2 className="font-bold text-lg sm:text-xl mt-8 mb-3">5. Disclaimer</h2>
            <p>
              Our services are provided "as is" without warranties of any kind.
            </p>
            
            <h2 className="font-bold text-lg sm:text-xl mt-8 mb-3">6. Contact</h2>
            <p>
